...
// each the tracked mesh vertex closest to it on the canonical face - the
// same table core/tracking/face106.zig defines for the native shells,
// ported verbatim so a lens effect that reads it behaves identically
// regardless of which shell tracked the frame.

export const POINT_COUNT = 106;
...
/// image-space sense a tracked landmark's own x/y already use.
